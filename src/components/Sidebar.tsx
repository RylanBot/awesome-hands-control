        ...
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-10">
            <div className="bg-white p-6 rounded-lg shadow-xl relative ml-16">
                ...
                <div className="flex justify-end items-center">
                    <img className="w-5 h-5 mr-2" src="./images/icons/GitHub.png" />
                    <p
                        className="text-teal-500 cursor-pointer"
                        onClick={() =>
                            window.windowApi.openExternalLink(
                                "https://github.com/RylanBot/awesome-hands-control"
                            )
                        }
                    >
...
const Sidebar: React.FC = () => {
    ...
    return (
        <div className="w-30 fixed top-0 left-0 h-full bg-teal-500 flex flex-col items-center justify-between p-4">
            <img 
                className="w-16"
                src="./images/icons/AwesomeTitle.png" 
            />
            <button
            ...
            <button
                className="text-white hover:text-teal-800 p-2"
